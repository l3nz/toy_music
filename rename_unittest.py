...
class TestRename(unittest.TestCase):
    ...
    def test_creazione(self):
        ...
        r = Rename()
        self.assertEqual("Files: 0 (non-uniques: 0) - Max code: '0000' - Rewrite rules: 0", r.stats())
    ...
    def test_find_non_uniques_with_prefix(self):
        ...
        r = Rename()
        r.list_of_filenames([ "0003-a.mp3", "x/b.mp3", "x/0004-a.mp3", "y/c.mp3", "0002-c.mp3" ])
        unq = r.find_non_uniques()
        self.assertEqual(2, len(unq))
    ...
    def test_find_max_code_present(self):
        """Test non unici"""
        r = Rename()
        r.list_of_filenames([ "0023-a.mp3", "x/0054-b.mp3", "x/0002-a.mp3", "y/c.mp3", "c.mp3" ])
    ...
    def test_stats(self):
        ...
        self.assertEqual("Files: 3 (non-uniques: 1) - Max code: '0000' - Rewrite rules: 2", r.stats())
